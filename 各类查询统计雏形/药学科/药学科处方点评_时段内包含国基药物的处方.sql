...
AND A.开嘱医生 <> '系统管理员'
AND A.医嘱状态 = 8
AND A.开嘱时间 BETWEEN to_date('20230210000000', 'yyyy-mm-dd hh24:mi:ss') AND to_date('20230211235959', 'yyyy-mm-dd hh24:mi:ss')
AND D.NO IN (
