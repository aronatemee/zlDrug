/* 药学科处方点评用。时段内包含糖皮质激素的处方，其明细。
糖皮质激素 ：醋酸泼尼松片、地塞米松磷酸钠注射液、醋酸地塞米松片
*/
select * from (
select * from (
...
AND A.开嘱医生 <> '系统管理员'
AND A.医嘱状态 = 8
AND A.开嘱时间 BETWEEN to_date('20230401000000', 'yyyy-mm-dd hh24:mi:ss') AND to_date('20230630235959', 'yyyy-mm-dd hh24:mi:ss')
AND D.NO IN (
...
AND A.医嘱状态 = 8
AND A.开嘱时间 BETWEEN to_date('20230401000000', 'yyyy-mm-dd hh24:mi:ss') AND to_date('20230630235959', 'yyyy-mm-dd hh24:mi:ss')
AND (a.医嘱内容 like '%醋酸泼尼松片%'
or a.医嘱内容 like '%地塞米松磷酸钠注射液%'
or a.医嘱内容 like '%醋酸地塞米松片%')
)
